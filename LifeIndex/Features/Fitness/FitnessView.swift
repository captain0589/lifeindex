...
// MARK: - Fitness Scrollable Week Selector

private struct FitnessScrollableWeekSelector: View {
    let dates: [Date]
...
// MARK: - Fitness Week Row (7 days)

private struct FitnessWeekRow: View {
    let dates: [Date]
    @Binding var selectedDate: Date
    let accentColor: Color
    let hasDataForDate: (Date) -> Bool
