...
struct SleepStagesBreakdown: View {
    let stages: SleepStages
    let color: Color
            ...
            HStack(spacing: Theme.Spacing.xl) {
                if let today = todayScore {
                    ComparisonTile(
                        ...
                        tileBackground: AnyShapeStyle(scoreColor(today).opacity(0.1))
                    )
                }
                if let yesterday = yesterdayScore {
                    ComparisonTile(
                        ...
                        value: "\(yesterday)",
                        color: scoreColor(yesterday),
                        tileBackground: AnyShapeStyle(scoreColor(yesterday).opacity(0.1))
                    )
                }
                if let avg = weeklyAvg {
                    ComparisonTile(
                        ...
                        tileBackground: AnyShapeStyle(scoreColor(avg).opacity(0.1))
                    )
                }
            }
